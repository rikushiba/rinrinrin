...
public class FrameScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (ss.Close.activeSelf || ss.MenuText.activeSelf || ss.MapMenu.activeSelf || ss.Yes.activeSelf || ss.No.activeSelf || (ss.Tenkuu.activeSelf && ss.Close.activeSelf && ss.Frame2.activeSelf) || ss.BouekiMenu.activeSelf)
        {
